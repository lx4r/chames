class PriceCheck {
    getGamePrice(gameID) {
        ...
        return this.getJSONFromURL(gameAPIURL).then((jsonObject) => {
            if (jsonObject.hasOwnProperty(PriceCheck.G2A_API_LOWEST_PRICE_ATTRIBUTE)) {
                return jsonObject[PriceCheck.G2A_API_LOWEST_PRICE_ATTRIBUTE];
            }
            else {
...
PriceCheck.G2A_API_URL = 'https://www.g2a.com/marketplace/product/auctions/?id=';
PriceCheck.G2A_API_LOWEST_PRICE_ATTRIBUTE = 'lowestPrice';
//# sourceMappingURL=PriceCheck.js.map